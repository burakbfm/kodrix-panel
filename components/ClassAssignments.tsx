...
import { Plus, Trash2, FileText, Calendar, CheckCircle, Clock } from "lucide-react";
                ...
                <>
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mt-1">Sınıf ödevlerini yönetin</p>
                        </div>
                        <button
                    ...
                    {assignments.length > 0 ? (
                        <div className="grid gap-4">
                            {assignments.map((assignment) => {
                                ...
                                return (
                                    <div
                                        key={assignment.id}
                                        className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:shadow-md transition"
                                    >
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                <div className="bg-orange-100 dark:bg-orange-900/20 p-2.5 rounded-lg text-orange-600 dark:text-orange-400">
                                        ...
                                        <div className="flex items-center gap-2 pl-14 md:pl-0">
                                            {/* 
                                                TODO: Add edit button or detail view link 
                                            */}
                                            <button
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700 p-12 text-center">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                                Öğrenciler için ilk ödevi oluşturun
                            </p>
                            <button
                                onClick={() => setIsCreating(true)}
