-- Ders Yönetim Sistemi için Veritabanı Şeması
-- Oluşturma Tarihi: 2026-02-08

-- 1. Ders Taslakları Tablosu
...
-- 3. Sınıf-Ders Atamaları Tablosu
...
-- 5. Ders Ödevleri Tablosu (İsteğe bağlı - şimdilik ekleyelim)
...
-- 6. Öğrenci Ödev Gönderimleri Tablosu
...
CREATE POLICY "Öğrenciler kendi ilerlemelerini güncelleyebilir" ON student_lesson_progress FOR INSERT WITH CHECK (
    student_id = auth.uid()
);
