...
import { LayoutDashboard, Users, DollarSign, BookOpen, LogOut } from "lucide-react";
        ...
        <div className="flex h-screen bg-gray-50 dark:bg-gray-950 transition-colors">
            ...
            <aside className="w-64 bg-kodrix-purple dark:bg-amber-500 flex flex-col fixed inset-y-0 left-0 z-50 transition-colors duration-300">
                ...
                <nav className="flex-1 p-4 space-y-2">
                    ...
                    <Link href="/admin" className="flex items-center gap-3 px-4 py-3 rounded-lg text-white/80 dark:text-gray-900/80 hover:bg-white/10 dark:hover:bg-black/5 hover:text-white dark:hover:text-gray-900 transition group">
                        <LayoutDashboard className="w-5 h-5 text-amber-400 dark:text-kodrix-purple" />
                        <span className="font-medium">Genel Bakış</span>
                    </Link>

                    <Link href="/admin/classes" className="flex items-center gap-3 px-4 py-3 rounded-lg text-white/80 dark:text-gray-900/80 hover:bg-white/10 dark:hover:bg-black/5 hover:text-white dark:hover:text-gray-900 transition group">
                        <BookOpen className="w-5 h-5 text-amber-400 dark:text-kodrix-purple" />
                        <span className="font-medium">Sınıflar & Dersler</span>
                    </Link>

                    <Link href="/admin/users" className="flex items-center gap-3 px-4 py-3 rounded-lg text-white/80 dark:text-gray-900/80 hover:bg-white/10 dark:hover:bg-black/5 hover:text-white dark:hover:text-gray-900 transition group">
                        <Users className="w-5 h-5 text-amber-400 dark:text-kodrix-purple" />
                        <span className="font-medium">Kullanıcılar</span>
                    </Link>

                    <Link href="/admin/finance" className="flex items-center gap-3 px-4 py-3 rounded-lg text-white/80 dark:text-gray-900/80 hover:bg-white/10 dark:hover:bg-black/5 hover:text-white dark:hover:text-gray-900 transition group">
                        <DollarSign className="w-5 h-5 text-amber-400 dark:text-kodrix-purple" />
