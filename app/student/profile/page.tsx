            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-kodrix-purple dark:border-amber-500 p-8 max-w-2xl">
                <div className="flex items-center gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <span className="inline-flex items-center gap-1 px-3 py-1 mt-2 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-sm font-medium">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4 p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
                        ...
                        <div>
                            ...
                            <p className="text-gray-900 dark:text-white">{profile?.parent_name || "-"}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
                        ...
                        <div>
                            ...
                            <p className="text-gray-900 dark:text-white">{profile?.parent_phone || "-"}</p>
                        </div>
                    </div>
                </div>
            </div>
